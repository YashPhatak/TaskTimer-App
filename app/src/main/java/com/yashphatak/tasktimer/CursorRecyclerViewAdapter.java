    ...
    public void onBindViewHolder(CursorRecyclerViewAdapter.TaskViewHolder holder, int position) {
       // Log.d(TAG, "onBindViewHolder: starts");
        if ((mCursor == null) || (mCursor.getCount() == 0)) {
            ...
            holder.editButtton.setVisibility(View.GONE);
            ...
            final Task task = new Task(mCursor.getLong(mCursor.getColumnIndex(TasksContract.Columns._ID)),
                    mCursor.getString(mCursor.getColumnIndex(TasksContract
                            .Columns.TASKS_NAME)),
                    mCursor.getString(mCursor.getColumnIndex(TasksContract
                            .Columns.TASKS_DESCRIPTION)),
                    mCursor.getInt(mCursor.getColumnIndex(TasksContract
                            .Columns.TASKS_SORTORDER)));

            holder.name.setText(task.getName());
            holder.description.setText(task.getDescription());
            holder.editButtton.setVisibility(View.VISIBLE);
...
//                    Log.d(TAG, "onClick: task name is " + task.getName());
            ...
            holder.editButtton.setOnClickListener(buttonListener);
    ...
    /**
     * Swap in a new Cursor ,return in a new Cursor
     * the returned old cursor is <em>not</em> closed
     *
     * @param newCursor the new cursor to be used
     * @return returns the previously set cursor, or null if there wasnt one
     * if the given new cursor is the same instance as previously set
    ...
    Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            //notify observers about lack of dataset
    ...
    static class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        public TaskViewHolder(View itemView) {
           ...
           // Log.d(TAG, "TaskViewHolder: starts");
            ...
            this.editButtton = (ImageButton) itemView.findViewById(R.id.tli_edit);
