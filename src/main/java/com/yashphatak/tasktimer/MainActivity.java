...
import static com.yashphatak.tasktimer.R.id.fragment;
...
import com.yashphatak.tasktimer.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements CursorRecyclerViewAdapter.OnTaskClickListener,
    ...
    //whether activity is in two-pane mode
    //running in landscape on a tablet
    ...
    private AlertDialog mDialog = null;//module scope because we need to dismiss it onStop
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if the addeditactivityfragment exists, we're editing
        Boolean editing = fragmentManager.findFragmentById(R.id.task_details_container)!=null;
        Log.d(TAG, "onCreate: editing is "+editing);

        //We need references to the containers, o we can show or hide them as necessary
        //No need to cast them, as we're only calling a method that's for all views
        View addEditLayout = findViewById(R.id.task_details_container);
        View mainFragment = findViewById(fragment);
        ...
        if(mTwoPane){
            ...
            //hide left hand fragment,to make room for editing
    ...
    public void onSaveClicked() {
        ...
        if(!mTwoPane){
            ...
            addEditLayout.setVisibility(View.GONE);
            //make sure MainActivityFragment is visible
            mainFragment.setVisibility(View.VISIBLE);
...
//                Log.d(TAG, "onClick: Entering messageView.onClick, showing = "+mDialog.isShowing() );
    ...
    private void taskEditRequest(Task task) {
        ...
        if(!mTwoPane){
            ...
            //hide left hand fragment and show the right hand frame
            View mainFragment = findViewById(R.id.fragment);
            View addEditLayout = findViewById(R.id.task_details_container);
            mainFragment.setVisibility(View.GONE);
    ...
    public void onNegativeDialogResult(int dialogId, Bundle args) {
        ...
        switch ((dialogId)){
            ...
            case DIALOG_ID_CANCEL_EDIT:
            case DIALOG_ID_CANCEL_EDIT_UP:
                //if editing close the fragment, else remove the app
                FragmentManager fragmentManager = getSupportFragmentManager();
                Fragment fragment = fragmentManager.findFragmentById(R.id.task_details_container);
                if(fragment!=null){
                    //we were editing
